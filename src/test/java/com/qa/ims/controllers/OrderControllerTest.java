...
public class OrderControllerTest {
	...
	public void testCreate() {
		...
		final String DATE = "2020-09-17";
		final Order created = new Order(CUSTOMER_ID, DATE);
	...
	public void testReadAll() {
		...
		orders.add(new Order(1L, "2020-09-17"));
		orders.add(new Order(2L, "2020-09-17"));
		orders.add(new Order(3L, "2020-09-17"));
...
//		Order updated = new Order(1L, 2L, "2020-09-16");
//
